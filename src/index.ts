...
async function addItems(li: Element, listCont: Element, clientsIds: string[] | undefined) {
...
function enableDragAndDropListItem(client: HTMLElement) {
...
function enableDragAndDrop() {
    const listItems = document.querySelectorAll<HTMLElement>('.list-client');
